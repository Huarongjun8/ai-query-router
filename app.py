...
def route_query(query, has_files=False, has_images=False):
    ...
    if complexity_score >= 2 or word_count > 50:
        ...
        return "mistralai/Mistral-7B-Instruct-v0.3", "Mistral 7B (Simple query - Open source & free!)", 0.00000, "huggingface"
...
if mode == "Manual Override":
    model_choice = st.selectbox("Choose model:",
        ["Mistral 7B (Open Source - Free)", "Groq Llama 3.3 - Fast & Cheap", "GPT-4o Mini", "Claude Sonnet 4"])
            ...
            try:
                ...
                if mode == "Auto (Recommended)":
                    ...
                    if len(image_data) > 0:
                        ...
                        confidence = 95
                        reasoning = "Simple query (" + str(word_count) + " words, no complex keywords) - using free open-source Mistral"
                    else:
                    ...
                    energy_rates = {
                        ...
                        "mistralai/Mistral-7B-Instruct-v0.3": 0.0005,
                    ...
                    with st.expander("🔍 Routing Observability & Explainability", expanded=False):
                        ...
                        with obs_col2:
                            ...
                            if provider == "huggingface":
                                st.write("✅ Mistral 7B (selected) - Open source, FREE!")
                                ...
                                st.write("⚪ Mistral 7B - Free but less capable for medium tasks")
                                ...
                                st.write("⚪ Mistral 7B - Free but insufficient for this task")
...
with st.expander("ℹ️ How Auto-Routing Works"):
    ...
    - Ultra-simple queries: Mistral 7B (open source, FREE!)
    ...
    Cost Savings:
    - Mistral 7B: FREE (open source via Hugging Face)
