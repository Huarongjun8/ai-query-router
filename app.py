...
if mode == "Manual Override":
    model_choice = st.selectbox("Choose model:",
        ["mistralai/Mistral-7B-Instruct-v0.3 (Open Source - Free)", "Groq Llama 3.3 - Fast & Cheap", "GPT-4o Mini", "Claude Sonnet 4"])
            ...
            try:
                ...
                if mode == "Auto (Recommended)":
                    ...
                    energy_rates = {
                        ...
                        "mistralai/Mistral-7B-Instruct-v0.3": 0.0005,": 0.0005,
